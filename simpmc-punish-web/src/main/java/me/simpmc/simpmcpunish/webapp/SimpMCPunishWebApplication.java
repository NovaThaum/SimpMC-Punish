...
public final class SimpMCPunishWebApplication {
    private static final Gson GSON = new GsonBuilder().disableHtmlEscaping().create();

    private SimpMCPunishWebApplication() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("SimpMC-Punish 网页服务已启动: http://" + displayHost(config.host()) + ":" + config.port());
