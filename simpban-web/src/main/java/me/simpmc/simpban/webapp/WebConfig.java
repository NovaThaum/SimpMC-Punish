    ...
    private static void printHelp() {
        System.out.println("""
                ...
                用法:
                  ...
                  java -jar simpban-web-1.0.jar --sqlite <SQLite文件或目录>
                  java -jar simpban-web-1.0.jar --mysql --mysql-host localhost --mysql-database simpban
