 ...
 */
package me.simpfun.simpban.cache;
...
public class CacheManager {
    ...
    public CacheManager(SimpBan plugin) {
    ...
    public String getStats() {
        return String.format("Bans: %d cached | Mutes: %d cached | IP Bans: %d cached | IP Mutes: %d cached", this.banCache.estimatedSize(), this.muteCache.estimatedSize(), this.ipBanCache.estimatedSize(), this.ipMuteCache.estimatedSize());
    }
