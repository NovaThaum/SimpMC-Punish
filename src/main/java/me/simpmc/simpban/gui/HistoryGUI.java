...
extends FastInv {
    ...
    public HistoryGUI(SimpBan plugin, Player staff, OfflinePlayer target, List<Punishment> history) {
        this(plugin, staff, target, history, 0);
    }

    public HistoryGUI(SimpBan plugin, Player staff, OfflinePlayer target, List<Punishment> history, int page) {
    ...
    public static void openAsync(SimpBan plugin, Player staff, OfflinePlayer target) {
