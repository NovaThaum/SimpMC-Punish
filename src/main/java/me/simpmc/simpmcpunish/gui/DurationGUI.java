...
import me.simpmc.simpmcpunish.gui.CustomDurationHandler;
...
extends FastInv {
    ...
    public DurationGUI(SimpMCPunish plugin, Player staff, OfflinePlayer target, PunishmentType type) {
    ...
    public static void openAsync(SimpMCPunish plugin, Player staff, OfflinePlayer target, PunishmentType type) {
