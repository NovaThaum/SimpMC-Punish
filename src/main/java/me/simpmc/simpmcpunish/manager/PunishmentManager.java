...
public class PunishmentManager {
    ...
    private final Set<UUID> suppressLeaveMessageFor = ConcurrentHashMap.newKeySet();

    public PunishmentManager(SimpMCPunish plugin, PunishmentDAO punishmentDAO, CacheManager cacheManager) {
        this.plugin = plugin;
    ...
    public boolean consumeKickLeaveMessageSuppression(UUID playerUuid) {
        return this.suppressLeaveMessageFor.remove(playerUuid);
    }
