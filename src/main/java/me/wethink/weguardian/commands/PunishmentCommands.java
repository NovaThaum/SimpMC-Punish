...
extends BaseCommand {
    ...
    @CommandPermission(value="weguardian.ban")
    ...
    @CommandPermission(value="weguardian.tempban")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.unban")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.mute")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.tempmute")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.unmute")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.banip")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.tempbanip")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.unbanip")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.muteip")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.tempmuteip")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.unmuteip")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.kick")
    @CommandCompletion(value="@players")
    ...
    public void onKick(CommandSender sender, String targetName, @Optional String reason) {
        ...
        String bypassPerm = this.plugin.getConfig().getString("bypass.permission", "weguardian.bypass");
    ...
    @CommandPermission(value="weguardian.punish")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.history")
    @CommandCompletion(value="@players")
    ...
    @CommandPermission(value="weguardian.admin")
    ...
    @CommandPermission(value="weguardian.help")
    @Description(value="Show all WeGuardian commands")
    public void onHelp(CommandSender sender) {
        String[] helpLines;
        for (String line : helpLines = new String[]{"", "&8&m\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501&r &c&lWeGuardian Help &8&m\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501", "", "&c/ban &7<player> [reason] &8- &fPermanently ban a player", "&c/tempban &7<player> <duration> [reason] &8- &fTemporarily ban", "&c/unban &7<player> &8- &fUnban a player", "", "&e/mute &7<player> [reason] &8- &fPermanently mute a player", "&e/tempmute &7<player> <duration> [reason] &8- &fTemporarily mute", "&e/unmute &7<player> &8- &fUnmute a player", "", "&d/banip &7<player> [reason] &8- &fIP ban a player", "&d/tempbanip &7<player> <duration> [reason] &8- &fTemp IP ban", "&d/unbanip &7<player> &8- &fRemove IP ban", "", "&b/muteip &7<player> [reason] &8- &fIP mute a player", "&b/tempmuteip &7<player> <duration> [reason] &8- &fTemp IP mute", "&b/unmuteip &7<player> &8- &fRemove IP mute", "", "&6/kick &7<player> [reason] &8- &fKick a player", "&a/punish &7<player> &8- &fOpen punishment GUI", "&a/history &7<player> &8- &fView punishment history", "", "&c/wg reload &8- &fReload configuration", "&c/wg help &8- &fShow this help menu", "", "&7Duration formats: &f1s, 30m, 6h, 7d, 4w, 1M, 1y", "&8&m\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501", ""}) {
    ...
    private void broadcastStaff(String message) {
        ...
        for (Player player : players) {
            if (!player.hasPermission("weguardian.staff")) continue;
